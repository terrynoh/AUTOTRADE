...
>
> **버전**: vLive 2 (2026-04-17)
> **현재 단계**: R16 Phase 1 + Phase 2 B 완료 → 월요일 LIVE 첫 실행 검증 대기
...
| 시각 | 이벤트 |
|------|--------|
| 06:40 | cron → autotrade.service 가동 |
| 09:30~09:50 | 수석님 종목 입력 (대시보드) |
...
- Cloudflare Named Tunnel (도메인: hwrimlab.trade, 대시보드 서브도메인: app.hwrimlab.trade)
- Telegram Bot (알림)
- cron + systemd (자동 가동)
